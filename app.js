...
var createNewTaskElement = function(taskString) {
    ...
    editInput.type = "text";
    editInput.className = "task text-input tasks-list__input";
...
var taskCompleted = function() {
    ...
    var listItem = this.parentNode;
    var listItemLabel = listItem.querySelector('.tasks-list__label');
    listItemLabel.classList.add('tasks-list__label_completed');
...
var taskIncomplete = function() {
    ...
    var listItem = this.parentNode;
    var listItemLabel = listItem.querySelector('.tasks-list__label');
    listItemLabel.classList.remove('tasks-list__label_completed');
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem, taskCompleted);
}
